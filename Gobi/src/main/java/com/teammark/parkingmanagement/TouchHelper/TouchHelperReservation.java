...
public class TouchHelperReservation extends ItemTouchHelper.SimpleCallback {
    private AdapterReservation adapterReservation;

    public TouchHelperReservation(AdapterReservation adapterReservation) {
    ...
    public void onSwiped(@NonNull @NotNull RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        if(direction == ItemTouchHelper.LEFT){
            adapterReservation.updateReservation(position);
            adapterReservation.notifyDataSetChanged();
        }else{
           adapterReservation.deleteReservation(position);
        }
    }
